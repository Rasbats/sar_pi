...
DlgDef::DlgDef(wxWindow* parent, wxWindowID id, const wxString& title,
  ...
  m_Time = new wxStaticText(m_panel111, wxID_ANY, _("--"), wxDefaultPosition,
                            wxDefaultSize, 0);
  m_Time->SetFont(wxFont(9, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                         wxFONTWEIGHT_NORMAL, false, "Arial"));
  m_Time->SetMinSize(wxSize(40, -1));

  bSizer141121->Add(m_Time, 0, wxALL, 5);

  m_staticText331121 = new wxStaticText(m_panel111, wxID_ANY, _("hour(s)"),
                                        wxDefaultPosition, wxDefaultSize, 0);
  m_staticText331121->Wrap(-1);
  m_staticText331121->SetFont(wxFont(9, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                     wxFONTWEIGHT_BOLD, false, wxT("Arial")));
