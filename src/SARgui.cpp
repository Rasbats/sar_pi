...
DlgDef::DlgDef( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText33112 = new wxStaticText( wx_panel_dome, wxID_ANY, _("m"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText331111 = new wxStaticText( wx_panel_dome, wxID_ANY, _("m"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText33211 = new wxStaticText( m_panel111, wxID_ANY, _("m"), wxDefaultPosition, wxDefaultSize, 0 );
